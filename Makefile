...
ARCH		?= $(SUBARCH)
CROSS_COMPILE	?= /home/ubuntu/android_tools/kernels/msm-4.14/toolchain/gcc/bin/aarch64-linux-android-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC		= /home/ubuntu/android_tools/kernels/msm-4.14/toolchain/clang/bin/clang
